...
\]
where $\{ \ve_i \}_{i=1}^3$ is an orthonormal basis (we use an orthonormal basis to simplify the derivation; this has
the standard property $\ve_1=E(\ve_2,\ve_3)$, $\ve_2=E(\ve_3,\ve_1)$, $\ve_3=E(\ve_1,\ve_2)$). 
...
\]
this is unique since the vector space of volume forms has dimension 1. Rewrite this as,
\begin{align*}
