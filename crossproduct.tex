...
\usepackage[paperheight=25cm,paperwidth=29cm,top=1.5cm,bottom=1.cm,left=7cm,right=7cm,]{geometry}
...
since 
\[
T_{y \otimes x} L_x (\vz) = T_{y \otimes x} (E(\vx,\vz))=g(\vx,E(\vx,\vz))\vy=0,
\]
and 
\[
T_{x \otimes y} L_x (\vz) = T_{x \otimes y} E(\vx,\vz)=g(\vy,E(\vx,\vz))\vx  =g(\vz,E(\vy,\vz))\vx
=T_{x \otimes E(y,x)}(\vz). 
\]
